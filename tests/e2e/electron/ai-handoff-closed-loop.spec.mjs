...
function createCodexAppServerE2ECommand(directory) {
...
test("Qoder ACP Agent Bridge streams public execution text without clipboard or automatic adoption", async () => {
  test.setTimeout(180_000);
