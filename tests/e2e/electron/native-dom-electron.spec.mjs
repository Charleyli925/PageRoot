...
test("Electron browser A to B to A reopens exact in-memory HTML and deduplicates reselection", async () => {
  test.setTimeout(180_000);
...
test("Electron restores multiple Registry tabs, the persisted active document, and external cold-start priority", async () => {
