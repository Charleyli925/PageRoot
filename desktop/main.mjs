...
function registerProjectIpc() {
  ...
  registerProjectIpcChannels({
    ...
    handlers: {
      ...
      setWorkbenchTabs: persistWorkbenchTabsState,
...
desktopRuntime.externalFileOpenDelivery = externalFileOpenDelivery;
desktopRuntime.deliverExternalMailboxHead = deliverExternalMailboxHead;
