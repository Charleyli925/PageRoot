...
- Extended by: [ADR 0068](0068-review-visual-verdict-gate.md), which adds bounded non-authoritative current-frame observation without restoring a capture owner or screenshots
