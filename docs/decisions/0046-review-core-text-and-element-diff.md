...
- Superseded in part by: [ADR 0068](0068-review-visual-verdict-gate.md), which restores bounded current-frame observation without restoring a capture owner or screenshots
