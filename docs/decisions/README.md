...
`0055` through `0058`; future ADRs must use the next number above `0073`.
...
| 0022 | [v4 Registry-authorized project roots and promotion paths](0022-user-owned-project-root-identity.md) | Living; per-Version visible files superseded by ADR 0073 |
...
| 0074 | [Stemmio identity and local-storage boundary](0074-stemmio-identity-and-storage-boundary.md) | Accepted |
