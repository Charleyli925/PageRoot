...
| Unsaved composer/edit before send | No dirty composer when submitting | authority | sticky “continue filling” | Workbench + RunWorkflow both check | save or cancel | merge to RunWorkflow |
