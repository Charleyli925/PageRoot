...
| External OS/QoderWork HTML-open delivery, opaque request deduplication, deferred safe-switch retry and stale-result fencing | `desktop/external-file-open.mjs`, `app/application/external-file-open-session.js` |
