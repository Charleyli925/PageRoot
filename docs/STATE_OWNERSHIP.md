...
| Edit-canvas pointer-capability hover cursor, delayed outline and one-line caption | `HtmlCanvasEditor` presentation | none; disposable overlay hidden on click, scroll or text editing | canvas overlay |
