...
| Current source-backed comment target measurement status and coordinates | `HtmlCanvasEditor` presentation measurement | none; disposable snapshot tagged by rendered source Hash and applied page-view generation | Workbench comment rail |
