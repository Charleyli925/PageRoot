...
| Comment-rail disclosure and Canvas selection presentation | `CommentRailContainer` and `commentCanvasPort` | none; disposable React/adapter state only, never a comment fact | comment rail view only |
