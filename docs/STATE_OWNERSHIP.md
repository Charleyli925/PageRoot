...
| Current-source commit, same-directory atomic replacement and Project File settlement | `ProjectFileRepository` | source HTML working copy and `.pageroot` runtime/autosave records | `/autosave` route adapter and restart recovery |
