...
export function createQoderProvider({
  ...
  return defineAgentProvider({
    ...
    presentation: {
      agentName: "Qoder",
      description: "通过这台 Mac 上的 Qoder CLI 讨论或修改当前页面。",
      readyDetail: "真实预检已完成，可以继续。",
      notInstalledDetail: "这台 Mac 还没有可用的 Qoder CLI。",
      authRequiredDetail: "完成 Qoder 登录后即可继续。",
      unavailableDetail: "Qoder 当前不可用。",
      checkingDetail: "正在检查 Qoder CLI…",
