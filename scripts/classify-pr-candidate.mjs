...
const PACKAGING_PATTERNS = [
  ...
  /^bridge\//u,
  /^scripts\/(?:application-update-config|build-package|ci-evidence|create-release-assets|developer-preview|package-delivery-report|packaged-app-identity|release-app-checkpoint|release-app-stage|release-candidate-provenance|release-provenance|source-gate-provenance|verify-packaged-artifact)\.mjs$/u,
